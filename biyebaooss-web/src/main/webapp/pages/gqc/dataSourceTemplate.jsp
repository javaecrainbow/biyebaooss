			...
			<div class="modal-body">
				<form class="form-horizontal" role="form">
					<div class="form-group">
						...
						<div class="col-lg-9">
							<div class="btn-group select" id="dataSourceType"></div>
							<span>*</span>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-lg-9">
							<button class="btn btn-default" id="dataSourceConnectionTest"
								type="button">
								<span class="glyphicon glyphicon-transfer"></span>&nbsp;测试连接
							</button>
						</div>
					</div>
				</form>
