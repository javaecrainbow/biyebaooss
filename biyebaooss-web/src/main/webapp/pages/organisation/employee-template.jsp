						...
						<div class="col-lg-6 form-group">
							...
							<div class="col-lg-8">
								<input type="text" class="form-control" placeholder="编号"
									id="employee-sn"><span class="required">*</span>
							</div>
						</div>
						<div class="col-lg-6 form-group">
							...
							<div class="col-lg-8">
								<input type="text" class="form-control" id="employee-name"
									placeholder="姓名"><span class="required">*</span>
							</div>
						</div>
					</div>
					<div class="form-group row">
						<div class="col-lg-6 form-group">
							...
							<div class="col-lg-8">
								<div data-role="condition" class="btn-group select"
									id="employee-gender"></div>
						...
						<div class="col-lg-6 form-group">
							...
							<div class="col-lg-8">
								<div class="btn-group select" id="select-department">
									<button data-toggle="item" class="btn btn-default"
										type="button">选择机构</button>
							...
							<div class="col-lg-8">
								<div class="input-group date form_datetime"
									...
									<input class="form-control" size="16" type="text" value=""
										style="width: 100%;"> <span class="input-group-addon"><span
