					...
					<tr>
						<td width="25%" style="vertical-align: top;">
							<div class="tree" id="departmentTree"
								style="width: 232px; height: 348px; border-top: 2px solid #DDDDDD; margin-right: 5px;"></div>
						</td>
						...
						<td colspan="2">
							<div class="panel panel-default">
								<div class="panel-heading">
									任职岗位<span style="color: #428BCA;">(点击设置主岗位)</span>
								</div>
								<div class="panel-body" id="selectedPost"></div>
							</div>
						</td>
					</tr>
				</table>
