			...
			<div class="modal-body">
				<form class="form-horizontal" role="form">
					<div class="form-group">
						...
						<div class="col-lg-8">
							<input type="text" class="form-control" id="positionSn"><span
								class="required">*</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-lg-8">
							<input type="text" class="form-control" id="positionName"><span
								class="required">*</span>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							<div class="btn-group select" id="positionJob"></div>
							<span class="required">*</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-lg-8">
							<div class="radio">
								<span><input value=true type="radio"
									name="organizationPrincipal" style="opacity: 0;"></span>
							</div>
							<span style="position: relative; top: 5px;">是</span>
							&nbsp;&nbsp;&nbsp;
							<div class="radio">
								<span class="checked"><input type="radio"
									checked="checked" value=false name="organizationPrincipal"
