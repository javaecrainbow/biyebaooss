...
<div class="department-detail" id="departmentDetail">
	<ul class="u-tree tree" id="departmentTree"
		oncontextmenu="return false"></ul>
	<div class="right-content">
		<table class="table table-bordered table-hover base-info">
			<tr>
				<td><label class="col-lg-5 control-label">编号:</label>
					<div class="col-lg-7">
						<span data-role="number"></span> <input type="hidden"
							data-role="id"> <input type="hidden"
							data-role="organizationType">
					</div></td>
			</tr>
			<tr>
				<td><label class="col-lg-5 control-label">名称:</label>
					<div class="col-lg-7">
						<span data-role="name"></span>
					</div></td>
			</tr>
			<tr>
				<td><label class="col-lg-5 control-label">机构负责人:</label>
					<div class="col-lg-7">
						<span data-role="principalName"></span>
					</div></td>
			</tr>
			<tr>
				<td><label class="col-lg-5 control-label">描述:</label>
					<div class="col-lg-7">
		...
		<div class="btn-group buttons pull-right">
			<ks:hasSecurityResource identifier="organizationManagerAddCompany">
				<button id="addCompany" type="button" class="btn btn-primary">
					<span class="glyphicon glyphicon-plus"></span>&nbsp;创建分公司
				</button>
			</ks:hasSecurityResource>
			<ks:hasSecurityResource identifier="organizationManagerAddDepartment">
				<button id="addDepartment" type="button" class="btn btn-primary">
					<span class="glyphicon glyphicon-plus"></span>&nbsp;创建下级部门
				</button>
			</ks:hasSecurityResource>
			<ks:hasSecurityResource
				identifier="organizationManagerEmployeeListBtn">
				<button id="employeeListBtn" class="btn btn-info" type="button">
					<span class="glyphicon glyphicon-user"></span>&nbsp;员工列表
				</button>
			</ks:hasSecurityResource>
			<ks:hasSecurityResource
				identifier="organizationManagerUpdateDepartment">
				<button id="updateDepartment" type="button" class="btn btn-success">
					<span class="glyphicon glyphicon-wrench"></span>&nbsp;修改
				</button>
			</ks:hasSecurityResource>
			<ks:hasSecurityResource identifier="organizationManagerUpdateCompany">
				<button id="updateCompany" type="button" class="btn btn-success">
					<span class="glyphicon glyphicon-wrench"></span>&nbsp;修改
				</button>
			</ks:hasSecurityResource>
			<ks:hasSecurityResource identifier="organizationManagerDelete">
...
<script type="text/javascript"
	src="<c:url value='/js/organisation/department.js' />"></script>
<script type="text/javascript"
	src="<c:url value='/js/organisation/select-employee.js' />"></script>
