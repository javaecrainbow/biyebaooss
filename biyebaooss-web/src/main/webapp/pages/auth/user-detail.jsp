...
<div class="userDetial" id="userDetial">
	...
	<table class="table table-bordered table-hover">
		<tr>
			<td colspan="4"><label style="font-size: 20px;">①用户详细信息</label>
			</td>
		</tr>
		<tr>
			<td width="50%" colspan="2"><label class="control-label">姓名:</label>
				<span class="" data-id="name"></span></td>
			<td width="50%" colspan="2"><label class="control-label">用户名称:</label>
				<span class="" data-id="userAccount"></span></td>
		</tr>
		<tr>
			<td width="50%" colspan="2"><label>创建时间:</label> <span
				data-id="createDate"></span></td>
			<td width="50%" colspan="2"><label>描述:</label> <span
				data-id="description"></span></td>
		</tr>
		<tr>
			<td colspan="4"><label>是否可用:</label> <span data-id="disabled"></span>
			</td>
		</tr>
	</table>
	<!--
	...
	<table id="userDetialtoRoles" class="table table-bordered table-hover">
		<tr>
			<td colspan="2"><label style="font-size: 20px;">②所有角色</label></td>
		</tr>
		<tr>
    ...
    ========================所有权限=========================
     -->
	<table id="userDetialtoPermissions"
