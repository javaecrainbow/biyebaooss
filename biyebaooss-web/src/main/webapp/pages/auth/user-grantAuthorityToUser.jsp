		...
		<div class="modal-dialog" style="width: 900px;">
			<div class="modal-content">
				...
				<div class="userGrantAuthority modal-body">
					...
					<div class="middle">
						<button class="btn btn-danger glyphicon glyphicon-chevron-left"
							id="notGrantAuthorityToUserButton">&nbsp;撤权</button>
						<br />
						<br />
						<br />
						<br />
						<button class="btn btn-success glyphicon glyphicon-chevron-right"
							id="grantAuthorityToUserButton">&nbsp;授权</button>
						<br />
						<br />
						<br />
						<br />
