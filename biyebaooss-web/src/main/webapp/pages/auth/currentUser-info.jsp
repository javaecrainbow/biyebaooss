...
<div class="user-info" id="user-info">
	<table class="table table-bordered table-hover">
		<tr>
			<td width="25%"><label>姓名:</label> <span data-id="name"></span>
			</td>
			<td width="25%"><label>用户名称:</label> <span data-id="userAccount"></span>
			</td>
		</tr>
		<tr>
			<td><label>创建时间:</label> <span data-id="createDate"></span></td>
			<td><label>最后更改时间:</label> <span data-id="lastModifyTime"></span>
			</td>
		</tr>
		<tr>
			<td><label>邮箱:</label> <span data-id="email"></span>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a data-target="#changeEmailOfUser"
				onclick="" class="glyphicon glyphicon-pencil">修改</a></td>
			<td><label>联系电话:</label> <span data-id="telePhone"></span>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
				data-target="#changeTelePhoneOfUser" onclick=""
				class="glyphicon glyphicon-pencil">修改</a></td>
		</tr>
		<tr>
			<td><label>是否可用:</label> <span data-id="disabled"></span></td>
			<td><label>描述:</label> <span data-id="description"></span></td>
		</tr>
	</table>
