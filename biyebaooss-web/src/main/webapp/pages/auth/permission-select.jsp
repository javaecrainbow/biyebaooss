	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body"
				...
				<form id="selectPermissionForm" target="_self"
					class="form-inline searchCondition">
					<input type="hidden" class="form-control" name="page" value="0">
					<input type="hidden" class="form-control" name="pagesize"
						value="10">
							...
							<tr>
								<td>
									<div class="form-group">
										<label class="control-label">权限名称:&nbsp;</label> <input
											name="name" class="form-control" type="text" /> <label
											class="control-label">权限标识:&nbsp;</label> <input
											name="identifier" class="form-control" type="text" />
