	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body"
				style="padding-left: 45px; padding-right: 65px; height: 350px;">
				<form class="form-horizontal menu_form">
					<div class="form-group parentName">
						<label class="col-lg-3 control-label">父菜单名称:</label>
						<div class="col-lg-9">
							<input type="text" class="form-control" name="parentId" disabled><span
								class="required">*</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-lg-9">
							<input type="text" class="form-control" name="name"
								id="menuResourceName"><span class="required">*</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-lg-9">
							<input type="text" class="form-control" name="url"
								id="menuResourceNameUrl" /><span class="required">*</span>
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-3 control-label">菜单资源图片:</label>
						<div class="col-lg-9">
							<span id="menuIcon" class="menu-icon"></span> <input
								type="hidden" name="menuIcon" id="icon" />
