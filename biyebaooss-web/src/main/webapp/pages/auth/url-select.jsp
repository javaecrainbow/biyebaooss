	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body"
				...
				<form id="selectUrlFrom" target="_self"
							...
							<tr>
								<td>
									<div class="form-group">
										<label class="control-label">URL名称:&nbsp;</label> <input
											name="name" class="form-control" type="text" /> <label
											class="control-label">URL路径:&nbsp;</label> <input name="url"
											class="form-control" type="text" />
									</div>
								</td>
								<td style="vertical-align: bottom; padding: 0 5px;">
									<button id="selectUrlsearch" type="button"
