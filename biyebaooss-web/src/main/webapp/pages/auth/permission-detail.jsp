...
<div id="permissionDetail">
	...
	<table class="table table-bordered table-hover">
		<tr>
			<td colspan="3"><label style="font-size: 20px;">①权限详细信息</label>
			</td>
		</tr>
		<tr>
			<td width="33.333%"><label class="control-label">权限名称:</label> <span
				class="" data-id="permName"></span></td>
			<td width="33.333%"><label class="control-label">权限标识:</label> <span
				class="" data-id="permIdentifier"></span></td>
			<td width="33.333%"><label class="control-label">权限描述:</label> <span
				class="" data-id="permDescription"></span></td>
		</tr>
	</table>
	<!--
    ========================菜单=========================
	...
	<table class="table table-bordered table-hover">
		<tr>
			<td colspan="3"><label style="font-size: 20px;">②菜单资源</label></td>
		</tr>
		<tr>
			<td width="33.333%"><label class="control-label">菜单名称:</label> <span
				class="" data-id="menuName"></span></td>
			<td width="33.333%"><label class="control-label">菜单URL:</label>
				<span class="" data-id="menuUrl"></span></td>
			<td width="33.333%"><label class="control-label">菜单描述:</label> <span
				class="" data-id="menuDescription"></span></td>
		</tr>
	</table>
	<!-- ========================  URL访问资源  ========================= -->
	<table class="table table-bordered table-hover">
		<tr>
			<td colspan="3"><label style="font-size: 20px;">③URL访问资源</label>
			</td>
		</tr>
		<tr>
			<td width="33.333%"><label class="control-label">URL名称:</label>
				<span class="" data-id="urlName"></span></td>
			<td width="33.333%"><label class="control-label">URL路径:</label>
				<span class="" data-id="urlPath"></span></td>
			<td width="33.333%"><label class="control-label">URL描述:</label>
				<span class="" data-id="urlDescription"></span></td>
		</tr>
	</table>

	<table class="table table-bordered table-hover">
		<tr>
			<td colspan="3"><label style="font-size: 20px;">④页面元素资源</label>
			</td>
		</tr>
		<tr>
			<td width="33.333%"><label class="control-label">页面元素名称:</label>
				<span class="" data-id="pageName"></span></td>
			<td width="33.333%"><label class="control-label">页面元素标识:</label>
				<span class="" data-id="pageIdentifier"></span></td>
			<td width="33.333%"><label class="control-label">页面元素描述:</label>
				<span class="" data-id="pageDescription"></span></td>
		</tr>
	</table>
